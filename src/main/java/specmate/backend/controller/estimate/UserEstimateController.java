...
public class UserEstimateController {
    ...
    @PostMapping
    public ResponseEntity<UserEstimateResponse> createEstimate(
            @RequestBody UserEstimateRequest req,
    ...
    public ResponseEntity<UserEstimateProductResponse> addProductToEstimate(
            @PathVariable String estimateId,
            @RequestBody UserEstimateProductRequest req,
            Authentication authentication
    ) {
        String userId = (String) authentication.getPrincipal();
        return ResponseEntity.ok(userEstimateService.addProductToEstimate(estimateId, req));
    }
    ...
    public ResponseEntity<UserEstimateProductResponse> saveToMyEstimate(
            @RequestBody UserEstimateProductRequest req,
            Authentication authentication
    ) {
        String userId = (String) authentication.getPrincipal();
    ...
    public ResponseEntity<List<UserEstimateProductResponse>> getEstimateProducts(
            @PathVariable String estimateId,
            Authentication authentication
    ) {
        String userId = (String) authentication.getPrincipal();
    ...
    public ResponseEntity<Void> deleteEstimate(
        ...
        String userId = (String) authentication.getPrincipal();
        userEstimateService.deleteEstimate(estimateId);
